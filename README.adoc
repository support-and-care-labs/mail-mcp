...
Development guide:: link:docs/development.adoc[Development workflow, project structure, tools]
MCP Server:: link:docs/mcp-server.adoc[Setting up and using the MCP server with Claude Desktop]
Docker setup:: link:docs/docker.adoc[Running Elasticsearch and services with Docker]
Data management:: link:docs/data-management.adoc[Working with mbox files and archives]
Roadmap:: link:docs/roadmap.adoc[Implementation status and planned features]
Architecture decisions:: link:docs/adr/[ADRs documenting key technical decisions]
