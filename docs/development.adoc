...
----
poetry run pytest
poetry run pytest --cov=mail_mcp
----
...
poetry run pytest tests/test_email_parser.py
----

=== Working with Elasticsearch

See link:docker.adoc[Docker Setup] for running Elasticsearch locally.
...
* link:docker.adoc[Docker Setup]
* link:data-management.adoc[Data Management]
* link:roadmap.adoc[Roadmap and Implementation Status]
