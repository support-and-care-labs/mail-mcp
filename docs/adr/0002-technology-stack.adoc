...
Following link:0001-storage-and-access-strategy.adoc[ADR-0001], we have decided to implement mail-mcp using Elasticsearch as the primary storage backend.
...
* link:0001-storage-and-access-strategy.adoc[ADR-0001: Storage and Access Strategy]
