...
MCP server application providing HTTP/SSE transport.

Image:: Built from local Dockerfile
Ports:: 58080 (HTTP/SSE)
Access:: http://localhost:58080/sse (for MCP clients)
...
Once services are running, configure your MCP client to connect via SSE:
