...
This is the recommended way to run the infrastructure.
...
[TIP]
====
The docker-compose.yml is also available for download: link:{attachmentsdir}/docker-compose.yml[docker-compose.yml^]
====
...
Ports:: 58080 (Streamable HTTP)
Access:: http://localhost:58080/mcp (for MCP clients)
...
Image:: `ghcr.io/support-and-care-labs/mail-mcp:latest`
Platforms:: linux/amd64, linux/arm64
Schedule:: Hourly updates of current month's mbox
Function:: Retrieves and re-indexes latest emails automatically
...
include::ROOT:partial$mcp-config.adoc[]
...
# Start Elasticsearch and Kibana (for data exploration)
