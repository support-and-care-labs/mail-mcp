...
✅ Docker Compose configuration with Elasticsearch
...
✅ Elasticsearch client wrapper (async)
✅ Index schema definition for email messages
...
✅ Header extraction (From, To, Subject, Date, Message-ID, References)
✅ Body extraction from multipart MIME
✅ Encoding handling (UTF-8, ISO-8859-1, etc.)
✅ List information extraction

== Recently Completed

=== Metadata Extraction ✅

✅ JIRA references extraction (MNG-1234, MRESOLVER-567, etc.)
✅ GitHub references (PR numbers, commit SHAs)
✅ Version number detection
✅ Decision indicators (votes, keywords like "decided", "consensus")
✅ Quote detection and filtering
✅ Effective body extraction (quotes removed)

=== Indexing Pipeline ✅

✅ Bulk indexing with progress tracking
✅ CLI tool for indexing single files or directories
...
See link:adr/[Architecture Decision Records] for detailed discussions.

== Contributing

Want to help implement features?
See link:development.adoc[Development Guide] for setup and contribution guidelines.
...
* link:adr/0001-storage-and-access-strategy.adoc[ADR-0001: Storage Strategy]
* link:adr/0002-technology-stack.adoc[ADR-0002: Technology Stack]
