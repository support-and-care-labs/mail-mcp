...
Archive URLs are resolved on-demand and cached in Elasticsearch.
To populate the cache for a specific message:
...
See xref:adr/0003-archive-url-resolution.adoc[ADR-0003] for technical details on the URL resolution strategy.
