...
* Indexed mailing list data (see link:data-management.adoc[Data Management])
...
See link:data-management.adoc[Data Management] for details.
...
For large-scale deployments, see link:development.adoc#performance-optimization[Performance Optimization].
...
* link:data-management.adoc[Data Management]
* link:roadmap.adoc[Roadmap and Features]
